...
def inner_steps(model, data_iterator, optimizer, num_steps, device):
    ...
    if _compiled_train_fn is None:
        ...
        def _eager_train_step(input_ids, labels):
        ...
        if is_cuda_device:
            try:
                ...
                _compiled_train_fn = _eager_train_step
        else:
            _compiled_train_fn = _eager_train_step
    ...
    for current_step in range(num_steps):
        ...
        loss, logits = _compiled_train_fn(current_batch[:, :-1], current_batch[:, 1:])
        ...
        if current_step == num_steps - 1:
            ...
            final_logits_tensor = logits.float()
